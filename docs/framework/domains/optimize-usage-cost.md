...
[フレームワーク](<https://www.finops.org/framework/>) / [ドメイン](<https://www.finops.org/framework/domains/>) / 使用量とコストの最適化

このドメインにおける活動は、システムを効果的に設計・構築し、時間の経過に伴う無駄や不要な使用量を削減し、リソースに支払う料金を最適化することで、あらゆる[FinOpsスコープ](<https://www.finops.org/topic/scopes/>)におけるテクノロジー利用の最適化を通じて価値を創出します。
...
**このドメインのケイパビリティは、組織が以下のことを行うのに役立ちます。**
  ...
  * [FOCUS](<https://focus.finops.org/>)を活用して効率性KPIを標準化する
...
[ ![](https://www.finops.org/wp-content/uploads/2024/03/Architecting-for-Cloud.svg) アーキテクチャ設計とワークロード配置 ](<https://www.finops.org/framework/capabilities/architecting-workload-placement/>) [ ![](https://www.finops.org/wp-content/uploads/2024/03/Rate-Optimization.svg) 料金の最適化 ](<https://www.finops.org/framework/capabilities/rate-optimization/>) [ ![](https://www.finops.org/wp-content/uploads/2024/03/Workload-Optimization.svg) 使用量の最適化 ](<https://www.finops.org/framework/capabilities/usage-optimization/>) [ ![](https://www.finops.org/wp-content/uploads/2024/03/Cloud-Sustainability.svg) サステナビリティ ](<https://www.finops.org/framework/capabilities/sustainability/>) [ ![](https://www.finops.org/wp-content/uploads/2024/03/Licensing-SaaS-1.svg) ライセンスとSaaS ](<https://www.finops.org/framework/capabilities/licensing-saas/>)
