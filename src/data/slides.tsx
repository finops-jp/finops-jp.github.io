...
const Slides: Slide[] = [
  {
    name: 'Akiho Miyamura',
    icon: 'https://github.com/akiho-miyamura.png',
    title: 'オープニング&FinOps Foundationの最近のトピック紹介 #JapanFinOps',
    url: 'https://speakerdeck.com/akimiya/opuningu-and-finops-foundationnozui-jin-notopitukushao-jie',
    preview: 'https://files.speakerdeck.com/presentations/241b041e5ae14cbdab09273f0846c30c/slide_0.jpg',
    date: '2025-03-16',
    capabilities: [],
    tags: [],
  },
  {
    ...
    preview: 'https://files.speakerdeck.com/presentations/86a162c1f75e4a4c945ffb356d053d29/slide_10.jpg',
    date: '2024-11-29',
  ...
  },
  {
    name: 'Satoshi Matsuzawa',
    icon: 'https://github.com/chacco38.png',
    title: 'AWSコスト削減ポイント紹介 #三大クラウドコスト削減術',
    url: 'https://speakerdeck.com/chacco38/awskosutoxue-jian-pointoshao-jie-v20241205',
    preview: 'https://files.speakerdeck.com/presentations/72dc4eea925d415bbf9e0257931dc328/slide_6.jpg',
    date: '2024-12-05',
  ...
  },
  {
    name: 'Satoshi Matsuzawa',
    icon: 'https://github.com/chacco38.png',
    title: 'FinOps Foundationを活用したFinOpsスキルの効率的な上げ方 #ochacafe',
  ...
  },
  {
    name: 'Satoshi Matsuzawa',
    icon: 'https://github.com/chacco38.png',
    title: 'FinOps実践によるビジネス価値の最大化へとシフトせよ #NEXTVMware資産',
    preview: 'https://files.speakerdeck.com/presentations/21235217a193485bb2b768206c64c1ae/slide_0.jpg',
    url: 'https://speakerdeck.com/chacco38/finopsshi-jian-niyorubizinesujia-zhi-nozui-da-hua-hetosihutoseyo-number-nextvmwarezi-chan',
    date: '2025-04-23',
    capabilities: ["finops-practice-operations"],
    tags: [],
  },
  {
    name: 'Satoshi Matsuzawa',
    icon: 'https://github.com/chacco38.png',
    title: 'クラウドFinOps―単なるクラウドコスト改善の先へ #Forkwell_Library',
    preview: 'https://files.speakerdeck.com/presentations/9952f57df9af4e2ca5f71322ecebf20e/slide_5.jpg',
    url: 'https://speakerdeck.com/chacco38/kuraudofinops-dan-narukuraudokosutogai-shan-noxian-he-number-forkwell-library',
    date: '2025-04-28',
    capabilities: ["finops-practice-operations"],
    tags: [],
  },
