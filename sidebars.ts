    ...
    },
    {
      ...
      items: [
        ...
        'framework/maturity-model',
        {
          ...
          items: [
            'framework/domains/understand-usage-cost',
            'framework/domains/quantify-business-value',
            'framework/domains/optimize-usage-cost',
        ...
        },
        {
          ...
          items: [
            ...
            'framework/capabilities/kpis-benchmarking',
            'framework/capabilities/unit-economics',
            'framework/capabilities/architecting-workload-placement',
            'framework/capabilities/rate-optimization',
            'framework/capabilities/usage-optimization',
            'framework/capabilities/sustainability',
            'framework/capabilities/licensing-saas',
            'framework/capabilities/finops-practice-operations',
            'framework/capabilities/governance-policy-risk',
            'framework/capabilities/finops-assessment',
            'framework/capabilities/automation-tools-services',
