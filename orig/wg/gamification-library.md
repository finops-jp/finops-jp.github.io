# Gamification Story Collection

Here’s a collection of Gamification ideas and stories created by the Working Group and its FinOps practitioners. These are to be reviewed and used alongside with the guidance from the [A Guide to Gamification in FinOps](<https://www.finops.org/wg/a-guide-to-gamification-for-finops/>).

#### Introducing the “Try FinOps Tournament”
...
We wouldn’t be able to tell these stories without the help and effort from the following people:
