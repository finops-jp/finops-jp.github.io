...
FinOps practitioners must learn the crucial difference between Cost Management (removing waste and applying commitments to existing workloads) and Optimization (architecting applications to inherently match resource needs and business value). Become advocates for engineers, collaborating with them to gain context on tool recommendations and avoid implementing changes (like automation scripts or purchasing commitments) without their consensus. It’s vital to set realistic expectations and communicate clear goals—shifting the focus from aggressive cost-cutting targets (like “cut cloud cost by 50%”) to measurable unit cost metrics and cultural change as the FinOps practice matures.

## On this page

  * [Understand the difference between optimization and cost management](<#understand-the-difference-between-optimization-and-cost-management>)
  * [Embrace internal competition](<#embrace-internal-competition>)
  * [Be an advocate for engineers](<#be-an-advocate-for-engineers>)
  * [Expectation on setting targets](<#expectation-on-setting-targets>)
  * [Tooling considerations](<#tooling-considerations>)
...
![Sample chart showing changes implemented giving a 50% reduction in the cost of running the instances](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201822%20847'%3E%3C/svg%3E)  
_Changes implemented giving a 50% reduction in the cost of running the instances_
