...
## Table of Contents
  ...
  * [Assessment Stage 4: Focus](<#assessment-stage-4-focus>)[ ](<https://assessment.finops.org/>)
  * [Try the FinOps Assessment Spreadsheet](<https://drive.google.com/drive/folders/1Jgc9ZAZKDims4A4vYZfLDNpPIUVipRld?usp=drive_link>)

## Introduction

FinOps is not a linear process with a clear start and end, but a continuous practice in which the FinOps team must continually mature its skills to adapt to the changing technology environment of its organization. From Cloud, to SaaS, PaaS, Data Centers, Data Cloud Platforms, and more, FinOps skills and capabilities to operate the practice need to iterate and evolve along with the shifts in technology and growth of infrastructure.
...
For each [assessment](<https://drive.google.com/drive/folders/1Jgc9ZAZKDims4A4vYZfLDNpPIUVipRld?usp=drive_link>), be very clear in establishing your:
