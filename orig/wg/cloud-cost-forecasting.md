# Exploring Cloud Cost Forecasting

**Summary:**

Establishing an effective cloud forecasting practice is essential for transforming variable cloud expenditures into predictable business drivers that support long-term investment and innovation. Organizations must first define the specific “why” behind their forecasting—such as budget alignment or commitment management—to determine the appropriate level of effort and granularity required. FinOps Practitioners should move beyond manual spreadsheets toward automated, frequency-optimized models that shift ownership to engineering leaders, ensuring that forecasts are based on real-world future plans rather than just historical trends.
...
![Diagram with reasons why forecasting is important to your FinOps team and organization.](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20600%20600'%3E%3C/svg%3E)
...
You’ll read a number of these exerpts from survey participants and interviewees in these callout boxes throughout the paper:

_At a recent meetup event a large financial institution described their driver was primarily for the management of their minimum spend commitments and since that was key to them it was worth a considerable amount of effort to set up and create a repeatable process. They also acknowledged that as much as this was the key reason a lot of the above reasons also applied making the effort even more worthwhile._
...
#### Application Rationalization and Rightsizing

Plans can provide insights and help reduce waste via collaborative justifications or approval processes which inform application rationallization stratagies. Opportunities to prevent future duplicated functionality or overprovisioned resources may also be surfaced at the planning phase.
...
_A large health insurance company stated, “We assumed while moving to Cloud that businesses are aware / informed how to forecast / estimate workloads, they are not.”_
...
![A diagram explaining simple forecasting](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201920%20392'%3E%3C/svg%3E)
...
![A diagram building upon simple forecasting, adding trend-based forecasting](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201920%20570'%3E%3C/svg%3E)
...
_Ensure you consider the month you are forecasting for. A 31 day month is 11% longer than a 28 day month, you should factor this in before you add in any other increases for trends or drivers._

![A diagram building upon the previous, adding driver-based forecasting](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201920%20752'%3E%3C/svg%3E)
...
_A large technology company stated, “Don’t ask for ‘sports car’ resources if you can manage on ‘power scooter’ instances, and we reduced cloud spend by 47% in last 18 months using this principle.”_
...
![A diagram building upon the previous, adding net-new workload forecasting](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201920%20937'%3E%3C/svg%3E)

_**Note:** workload costs come from cores or some compute metric for the license x time x rate._

The below image shows the beginning of your forecasting journey – determining your Forecasting type(s):

![A diagram showing the first level of forecasting growth](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201920%201105'%3E%3C/svg%3E)

If you choose to have a forecasting accuracy KPI (more later in the paper on KPIs) you may want to consider setting a different KPI for net new workloads due to the challenges associated with this type of forecasting. Also it might help win hearts and minds on your forecasting journey and also help those business areas coming along at a later date.
...
![A chart explaining granularity of cloud forecasting](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20654%20405'%3E%3C/svg%3E)
...
![A chart explaining frequency of updating cloud forecasting](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20654%20405'%3E%3C/svg%3E)
...
In order to _operate_ your forecasting process there should always be a forecasting review cycle. Forecasts are compared to actuals (_inform_), learning happens to help _optimize_ the forecasting process and the cycle continues. If you choose to do your forecasts and not review them regularly you really are missing out on the phases of FinOps and it goes against the principle of reporting being timely.
...
![A chart explaining time period of cloud forecasting](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20654%20405'%3E%3C/svg%3E)
...
![A diagram showing the first and second levels of forecasting growth](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201920%201105'%3E%3C/svg%3E)

## Survey key takeaways

Here are some key takeaways from the survey results, in addition to the analysis above.

![A chart explaining annual estimated cloud spending from survey respondents](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20654%20405'%3E%3C/svg%3E)
...
![A chart explaining main driver of cloud forecasting](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20696%20305'%3E%3C/svg%3E)
...
![A chart comparing actuals to cloud forecasting](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20653%20404'%3E%3C/svg%3E)
...
![A chart showing where respondents gather info to create cloud forecasts](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20696%20305'%3E%3C/svg%3E)
...
![A chart explaining the various methods that respondents use to create cloud forecasts](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20841%20369'%3E%3C/svg%3E)
...
![A chart explaining what respondents do when cloud forecasts exceed budget](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20841%20369'%3E%3C/svg%3E)
...
_An Insurance company “During contract renewals, we work closely with workload owners & department leaders to get a holistic view of spend trends for the next 3-5 years. We have been fairly accurate at enterprise level (only 10% variance), but we see large variance at department level.”_
...
Measuring performance is of great importance to most organizations. Before you start creating a cottage industry of statistical creation think about what is important to you and what a relevant measure might be. This section will evolve in future iterations of the paper but in order to get you started below are some KPIs geared towards forecasting, based on maturity.
...
_A practitioner from a software provider: “We would love to focus on forecast accuracy as much as the topline accuracy.”_

_A practitioner from an energy company: “While our forecasts are very accurate (up to 95%), a struggle we have encountered is effectively communicating what level of confidence we have in the forecasting that we produce.”_
...
The determination of using a tool also should include consideration to where you are in your cloud journey, how much cloud spend you have (or plan to have), integration into other tools or capabilities (cost optimization, etc).
...
![A diagram showing the first, second, and third levels of forecasting growth](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201920%201106'%3E%3C/svg%3E)
...
There is no doubt that cloud forecasting can be complex and varied based on industry, organization, maturity, and many other factors. There is no one simple answer on how to do it but the paper should give you enough food for thought to consider what is relevant and of interest to you and your organization. With your help it can continue to evolve and become an even better resource. Come and join the conversation in the Forecasting Chat group or get involved in the next sprints of the Working Group.
...
Thank you to all of our survey responders and interviewers, without your insights this paper would not be what it is today!
