...
This guidance is intended for [executive leaders](<https://www.finops.org/insights/finops-executive-technology-leader/>), typically one level below C-level (VP, SVP, or EVP), who shape and sponsor the FinOps practice to support strategic outcomes.
...
####  Crawl 
  ...
  * At least one initial [FinOps Scope](<http://finops.org/framework/scopes>) exists (often public cloud), but Scope boundaries and executive priority alignment are informal.
...
####  Walk 
  ...
  * Business outcomes and unit metrics improve within Scopes, with early [Unit Economics](<https://www.finops.org/framework/capabilities/unit-economics/>) and [Forecasting](<https://www.finops.org/framework/capabilities/forecasting/>) tied to demand signals.
...
####  Run 
  ...
  * [FinOps Scopes](<http://finops.org/framework/scopes>) are the standard lens to connect strategy, funding, adoption, and accountability across major technology spend areas.
  ...
  * Trusted FinOps insights are embedded in [Leadership](<https://www.finops.org/framework/persona/leadership/>) routines for portfolio governance, modernization sequencing, and long-term commitments.
...
#### **As someone in a FinOps Practitioner role, I will…**
  ...
  * Deliver [FinOps Education and Enablement](<https://www.finops.org/framework/capabilities/finops-education-enablement/>) so [Personas](<http://finops.org/framework/personas>) understand their responsibilities, decision inputs, and shared language for cost and value
...
### Enterprise-Level Measures
  ...
  * **FinOps capability and accountability awareness:** Applicable personas have an understanding of FinOps within their organization, their responsibilities within that and adopt a shared language for managing technology costs and value, for example the [FinOps Cost and Usage Specification (FOCUS).](<https://focus.finops.org/>)
...
Operational measures, such as allocation quality, forecasting accuracy, anomaly response, commitment performance, and optimization outcomes, should be sourced from the relevant [FinOps Framework](<https://www.finops.org/framework/>) capabilities and [FinOps KPIs library](<https://www.finops.org/wg/finops-kpis/>) and applied accordingly.
...
[ ![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2064%2036'%3E%3C/svg%3E) Onboarding Your AI Hire: A FinOps Foundation Playbook ](<https://www.finops.org/assets/onboarding-your-ai-hire-a-finops-foundation-playbook/>) [ ![](https://www.finops.org/wp-content/uploads/2026/07/YouTube-Thumb-Breakout-SHI-NRG.png) Governing AI Costs and Proving ROI: From Black Box to Board Slide ](<https://www.finops.org/assets/governing-ai-costs-and-proving-roi-from-black-box-to-board-slide/>) [ ![](https://www.finops.org/wp-content/uploads/2026/07/YouTube-Thumb-Breakout-CloudZero-DraftKings.png) The Last Cloud Bill: Where We’re Going, You Won’t Need One ](<https://www.finops.org/assets/the-last-cloud-bill-where-were-going-you-wont-need-one/>) [ ![](https://www.finops.org/wp-content/uploads/2026/04/YouTube-Thumb-Breakout-keynote.png) FinOps X Day London 2026 Keynote: Optimizing AI and SaaS Value, Executive Strategy Alignment ](<https://www.finops.org/assets/finops-x-day-london-2026-keynote-optimizing-ai-and-saas-value-executive-strategy-alignment/>)