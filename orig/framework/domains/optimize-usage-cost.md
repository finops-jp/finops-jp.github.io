...
Within this Domain, organizations take action throughout the lifecycle of their technology estates to introduce and improve the efficiency and cost effectiveness of their design and deployment. Organizations will measure efficiency in a variety of ways, including monetary cost, carbon usage, or more traditional IT operational efficiency measures. Actions in this Domain will include managing the types and amounts of technology resources used, when they are used, and the rates that are paid for required resources.

Optimizing technology usage requires action by many Personas across an organization continuously through the life of its systems. This Domain contains the Capabilities which allow engineering groups to architect, design, build, operate, and continuously optimize applications for cost-effective operation. Architecting for effective resource utilization, responsibly acting on the impact of carbon use, reacting to changes in usage requirements or new technology service availability, using licensed and SaaS models appropriately, and cost effective operational practices all lead to efficient use of technology investments.
...
**The Capabilities in this Domain will help the organization:**
  ...
  * Optimize resource utilization and efficiency by building both manual and automated policies to help teams with how they use technology services across the infrastructure landscape
...
**Optimizing Usage & Cost Answers the Questions:**
  ...
  * Are engineering and product teams taking initiative to be responsible for their technology use?
  * Are we making appropriate architecture, technology category, system design, license use, and operational feature choices when building applications?
